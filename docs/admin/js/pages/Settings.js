...
export async function renderSettings(container) {
    container.innerHTML = `
        ...
        <div class="adm-card anim-in anim-d1" style="background:var(--bg-card); border:1px solid var(--border-glass); border-radius:16px; padding:32px; max-width:800px;">
            ...
            <div style="margin-top:32px; padding:16px; background:rgba(59,130,246,0.1); border:1px solid rgba(59,130,246,0.2); border-radius:12px; display:flex; gap:16px; align-items:flex-start;">
